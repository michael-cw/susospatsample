...
This is a repository for the Joint Development Center - Survey Solutions Spatial Sampling Application to support survey sampling and implementation when using Spatial Resources for the sampling Process together with Survey Solutions Computer Assisted Survey System (CASS).
