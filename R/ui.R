  ...
  fluidPage(theme=file.path(fpwww, "bluish.css"),
            ...
            fluidRow(column(2, div(style="height:20px; text-align: center;",
                     ...
                     column(10, div(style="background-color:#0d47a1; margin-left:5%; margin-top:0px; margin-bottom:0px;
                                    ...
                                    h1("JDC - WB Sampling Application", align="center", style="color:#FFFFFF; margin:0 0 0 0;")))),
            ## CUSTOM CSS file
            ...
            div(id = "resetAll",
                sidebarLayout(
                  ...
                  sidebarPanel(width = 3, title="Input parameters",
                               tabsetPanel(type = "tabs", id = "Settings", selected = "Admin",
                                           tabPanel("Sample",
                                                    fluidRow(br(), br()),
                                                    fluidRow(
                                                      column(6,
                                                      ...
                                                      column(6 ,
                                                             ...
                                                             conditionalPanel("input.sampType=='Random Grid'|input.sampType=='Random Cluster'",
                                                                              radioButtons("strat", "Is the file stratified?", c("Yes", "No"), selected = "No", inline = F)
                                                             ),
                                                             # otherwise intro help text
                                                             conditionalPanel("input.sampType=='None'",
                                                                              helpText("RANDOM GRID refers to sampling at random from an in-app generated grid or an uploaded raster image in GeoTif format,
                                                                                         RANDOM CLUSTER samples randomly from a provide cluster map and/or population data.")
                                                             )
                                                      )
                                                    ),
                                                    conditionalPanel("input.sampType=='Random Grid'|input.sampType=='Random Cluster'",
                                                                     fluidRow(
                                                                       column(6,
                                                                              ...
                                                                              conditionalPanel("(input.sampType=='Random Grid' & input.popUpType!=2 |
                                                                                                       input.sampType=='Random Grid' & input.popCreate=='No')",
                                                                     ...
                                                                     fluidRow(column(width=2),
                                                                              column(width=8,
                                                                                     ...
                                                                                     conditionalPanel("input.sampType=='Random Grid'|input.sampType=='Random Cluster'",
                                                                                                      shinyjs::disabled(
                                                                                                        actionButton("modify", "Modify the data set", width = "100%",
                                                                                                                     icon("sync"),
                                                                     ...
                                                                     fluidRow(column(width=2),
                                                                              column(width=8,
                                                                                     ...
                                                                                     actionButton("genSamp", "Create Sample Population", width = "100%",
                                                                                                  icon("sync"),
                                                                                                  style="color: #FFFFFF;
                                                                     ...
                                                                     conditionalPanel("input.popCreate=='Yes'",
                                                                                      div(id="popData",
                                                                                          ...
                                                                                          conditionalPanel("input.popUpType==1",
                                                                                                           fluidRow(
                                                                                                             column(width=2),
                                                                                                             column(width=8,
                                                                                                                    # fileInput("pop_file_point", "Upload Points Data",
                                                                                                                    #           multiple = F,
                                                                                                                    #           accept = (c("application/zip", ".zip",
                                                                                                                    #                       "application/gzip", ".gz",
                                                                                                                    #                       "application/x-gzip",
                                                                                                                    ...
                                                                                                                    zipFileInput_ui("popPointUpload",
                                                                                                                                    ...
                                                                                                                                    accept = c("application/zip", ".zip",
                                                                                                                                               ...
                                                                                                                                               "application/x-gzip",
                                                                                                                                               "x-zip-compressed")),
                                                                                                                    helpText("Only .zip compressions
                                                                                                                                     are accepted by the application.
                                                                                                                                     File must be packed as single file
                                                                                                                                     with one column named 'latitude', and one
                                                                                                                                     column named 'longitude', names are case sensitive.")),
                                                                                                             column(width=2)
                                                                                                           ...
                                                                                                           div(
                                                                                                             shiny::HTML('<a href="https://sites.research.google/open-buildings/"
                                                                                                                                 target="_blank">
                                                                                                                                 Open Buildings Website (opens in new tab!)</a>'
                                                                                                             ),
                                                                                          ...
                                                                                          conditionalPanel("input.popUpType==2",
                                                                                                           fluidRow(
                                                                                                             column(width=2),
                                                                                                             column(width=8,
                                                                                          ...
                                                                                          conditionalPanel("input.popUpType==3",
                                                                                                           fluidRow(
                                                                                                             column(width=2),
                                                                                                             column(width=8,
                                                                                                                    fileInput("pop_file_build", "Upload Build Up Data",
                                                                                                                              ...
                                                                                                                              accept = (c("application/zip", ".zip",
                                                                                                                                          ...
                                                                                                                                          "application/x-gzip",
                                                                                                                                          "x-zip-compressed"))),
                                                                                                                    helpText("Only .gz compressions
                                                                                                                                     are accepted by the application.
                                                                                                                                     File must be packed as single file,
                                                                                                                                     with WKT geometry column")
                                                                                                             ),
                                                                                                             column(width=2)
                                                                                                           )
                                                                                          )
                                           ...
                                           tabPanel("Sample 2nd Stage",
                                                    fluidRow(br(), br()),
                                                    modal_spsample2stage_ui("my_modal")
                                           ),
                                           tabPanel("Admin", icon = icon("toolbox"),
                      ...
                      fluidRow(
                        ...
                        column(4,
                               tabsetPanel(id="tables",
                                           ...
                                           tabPanel(value="sample",title = "SAMPLE",
                                                    fluidRow(
                                                      column(1),
                                                      column(11,
                                                             DT::dataTableOutput("sample_table"), height = "540px")
                                                    ), br(), br(),
                                                    fluidRow(column(4),
                                                             column(6,
                                                                    hidden(
                                                                      div(id = "div_samplingreport",
                                           ...
                                           tabPanel(value="ressources",title = "SURVEY SOLUTIONS",
                                                    ...
                                                    fluidRow(column(1),
                                                             column(10,
                                                                    helpText("This section allows you to generate and download the geospatial ressources required
                                                                                    to conduct your survey with Survey Solutions. If you already have a survey solutions server, please
                                                                                    provide your API user credentials in the Admin section, so the files can be transferred directly.")),
                                                             column(1)),
                                                    br(),
                                                    fluidRow(
                                                      column(4),
                                                      column(6,
                                                             conditionalPanel("(input.sampType=='Random Cluster' |
                                                    ...
                                                    conditionalPanel("input.conf3==1",
                                                                     fluidRow(column(4),
                                                                              column(4,
                                                                                     h4("Map Tiles",
                                                                                        style="color: #0d47a1;
                                                                     ...
                                                                     fluidRow(column(4),
                                                                              column(6,
                                                                                     # downloadButton("dwl_frame", "Download Sample",
                                           ...
                                           tabPanel(value = "admin", title = "ADMIN",
                                                    div(id = "adminrightpan",
